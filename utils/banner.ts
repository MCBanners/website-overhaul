export function generateImageUrl(
  ...
  return `https://api.mcbanners.com/banner/resource/spigot/${id}/banner.png?background__template=${templateKey}&logo__size=${logoSize}&logo__x=${logoXOffset}&resource_name__x=${rXOffset}&resource_name__y=${rYOffset}&resource_name__font_size=${rFontSize}&resource_name__font_bold=${rFontBold}&resource_name__text_align=${rTextAlignment}&resource_name__font_face=${rFontFace}&resource_name__display=${rTextOverride}`;
}
